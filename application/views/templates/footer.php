<!-- footer section -->
<footer class="container flex flex-col gap-[40px] bg-[#232321] rounded-[24px] py-[24px] px-[16px] text-white font-open-sans font-medium text-base -mt-[30px] lg:rounded-[48px] lg:py-[50px] lg:px-[72px] lg:flex-row lg:text-[20px] lg:items-center lg:justify-between lg:-mt-[50px]">
    <div class="flex flex-col gap-[16px] items-start justify-center lg:max-w-[391px]">
        ...
        <h1 class="font-rubik font-bold text-[90px] text-[#9C9C9C] mt-[50px] hidden lg:block">NIMBLE</h1>
    </div>
        ...
        <div class="flex flex-col gap-[16px] items-start justify-center">
            ...
            <div class="flex gap-[16px] items-start justify-center lg:gap-[24px]">
                <a href="" class="block" target="_blank">
                    <img src="<?= base_url('public/icons/facebook.png'); ?>" class="block w-[24px]" alt="facebook" target="_blank" loading="lazy">
                </a>
                <a href="" class="block" target="_blank">
                    <img src="<?= base_url('public/icons/instagram.png'); ?>" class="block w-[24px]" alt="instagram" target="_blank" loading="lazy">
                </a>
                <a href="" class="block" target="_blank">
                    <img src="<?= base_url('public/icons/tiktok.png'); ?>" class="block w-[24px]" alt="tiktok" target="_blank" loading="lazy">
                </a>
            </div>
        </div>
    </div>
