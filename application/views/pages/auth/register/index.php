<!-- register section -->
<section
    class="mt-[32px] bg-off-white container w-full rounded-2xl px-4 pt-6 pb-[34px] flex flex-col gap-5 items-center justify-center lg:mt-[60px] lg:gap-6 lg:pt-5 lg:pb-[45px]">
    ...
    <form action="" method="post"
        ...
        <div class="flex flex-col gap-4 items-center justify-center w-full lg:gap-5">
            ...
            <div class="flex gap-[30px] items-center justify-center w-full">
                <div class="flex gap-2 items-center justify-start">
                    <input type="radio" name="gender" class="accent-royal-blue" id="male">
                    <label for="male" class="font-open-sans font-semibold text-base text-dark-charcoal">Male</label>
                </div>
                <div class="flex gap-2 items-center justify-start">
                    <input type="radio" name="gender" class="accent-royal-blue" id="female">
                    <label for="female" class="font-open-sans font-semibold text-base text-dark-charcoal">Female</label>
                </div>
                <div class="flex gap-2 items-center justify-start">
                    <input type="radio" name="gender" class="accent-royal-blue" id="other">
        ...
        <button type="submit"
            class="rounded-lg bg-dark-charcoal py-4 px-[102px] w-full text-white font-rubik text-sm font-medium flex gap-1 items-center justify-center lg:gap-2">Register
