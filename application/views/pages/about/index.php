...
<!-- ======= TEAM SECTION START ======= -->
<section class="container mt-[100px] flex flex-col items-center justify-center gap-[60px] w-full">
    <h2 class="font-rubik font-semibold text-[74px] text-dark-charcoal">OUR TEAMS</h2>
