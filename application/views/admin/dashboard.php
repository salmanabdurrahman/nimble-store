                                        ...
                                        <tr>
                                            ...
                                            <td class="h-px w-72 whitespace-nowrap">
                                                <div class="px-6 py-3 text-start">
                                                    <span
                                                        class="block text-sm font-semibold text-gray-800"><?php echo $order['id'] ?></span>
                                                </div>
                                            </td>
                                            <!-- <td class="h-px w-72 whitespace-nowrap">
                                                <div class="px-6 py-3 text-start">
                                            ...
                                            <td class="h-px w-72 whitespace-nowrap">
                                                <div class="px-6 py-3 text-start">
                                                    <span
                                                        class="block text-sm text-gray-800"><?php echo $order['username'] ?></span>
                                                </div>
                                            </td>
                                            <td class="h-px w-72 whitespace-nowrap">
                                                <div class="px-6 py-3 text-start">
                                                ...
                                                <div class="px-6 py-1.5 gap-2 flex items-center">
                                                    <?php if ($order['status'] == 'pending') : ?>
                                                        <a class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium"
                                                            href="<?= base_url('admin/order/' . $order['id'] . '/accept'); ?>"
                                                        ...
                                                        <a class="inline-flex items-center gap-x-1 text-sm text-red-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium"
                                                            href="<?= base_url('Admin/order/' . $order['id'] . '/cancel'); ?>"
                                                            onclick="return confirm('Are you sure you want to cancel this order?');">
                                                            Cancel
                                                        </a>
                                                    <?php elseif ($order['status'] == 'completed') : ?>
                                                        <a class="inline-flex items-center gap-x-1 text-sm text-gray-500 decoration-2 focus:outline-none focus:underline font-medium">
                                                            Accepted
                                                        </a>
                                                    <?php elseif ($order['status'] == 'cancelled') : ?>
                                                        <a class="inline-flex items-center gap-x-1 text-sm text-gray-500 decoration-2 focus:outline-none focus:underline font-medium">
